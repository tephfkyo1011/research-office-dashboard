const CACHE_VERSION = 'v37'; // 🟢 อัปเดตเป็น v36 เพื่อบังคับเคลียร์แคชเก่า ดึง app.js ตัวใหม่ แก้โค้ดต้องอัปเลขทุกครั้ง
...
const STATIC_ASSETS = [
  ...
  './',
  './index.html',
  './app.js?v=36', // 🟢 อัปเดตเป็น v35 เพื่อบังคับเคลียร์แคชเก่า ดึง app.js ตัวใหม่ แก้โค้ดต้องอัปเลขทุกครั้ง
  './offline.html',
  './ping.txt',
