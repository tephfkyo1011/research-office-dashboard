const CACHE_VERSION = 'v24'; // 🟢 อัปเดตเป็น v22 เพื่อบังคับเคลียร์แคชเก่า ดึง app.js ตัวใหม่ แก้โค้ดต้องอัปเลขทุกครั้ง
...
const STATIC_ASSETS = [
  ...
  './',
  './index.html',
  './app.js?v=24', // ทิ้งไว้แบบนี้ก่อน ทำเสร็จหมดทุกโปรแกรมค่อยมาขยับเลขทีเดียวครับ
  './offline.html',
  './ping.txt',
